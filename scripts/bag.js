...
function emptyBag() {
  ...
  <div class="empty-cart-container">
    ...
    <div class="empty-cart-wishlist">
      <button class="empty-cart-wishlist-btn">
...
function displayBagSummary() {
  ...
  if (bagItemObjects.length == 0) emptyBag();
...
function generateItemHTML(item) {
  let delivery_date = new Date(Date.now() + item.delivery_days * 24 * 60 * 60 * 1000)
